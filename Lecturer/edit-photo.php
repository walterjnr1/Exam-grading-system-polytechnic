...
move_uploaded_file($_FILES["userImage"]["tmp_name"],"../home/uploadImage/" . $_FILES["userImage"]["name"]);			
$location="uploadImage/" . $_FILES["userImage"]["name"];
			
$sql = " update tblteacher set photo='$location' where teacherID='$teacherID'";
...
<title>Edit Photo| <?php  echo $website_name  ?></title>
...
<div class="form-group">
    ...
    <p>&nbsp;</p>
                ...
                <div align="center"><img src="../home/<?php echo $rowaccess['photo'];   ?>" alt="studentphoto" width="178" height="154" id="logo-img">   
      </div>
    </div>
  </div>
