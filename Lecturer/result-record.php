...
if(empty($_SESSION['login_teacherID']))
    {   
  ...
  $teacherID = $_SESSION["login_teacherID"];
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"><span class="text-muted text-xs block">Teacher ID:<?php echo $teacherID;  ?> <b class="caret"></b></span> </span> </a>
                    ...
                    <div class="ibox-content">
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                          <thead>
                            <tr>
                            <th><div align="center" class="style1">Position</div></th>
                              <th><div align="center" class="style1">Admission ID </div></th>
                              ...
                              <th><div align="center" class="style1">Total</div></th>
                              <th><div align="center" class="style1">Average</div></th>
                          </thead>
                          <tbody>
                          <?php
		...
		//	$sql = "SELECT students.*, payment.* FROM students JOIN payment ON students.ID=payment.studentID where payment.studentID='$ID'";
		  ...
		  ?>
                            ...
                            <td><div align="center"><?php echo $row['position'];  ?> </div></td>
                              ...
                              <td class="center"><div align="center"><?php echo $row['grandtotal'];  ?></div></td>
                              <td class="center"><div align="center"><?php echo $row['average'];  ?></div></td>
                            </tr>
                            <?php $cnt=$cnt+1;} ?>
                          </tbody>
                          <tfoot>
