...
$rowaccess = mysqli_fetch_array($result);
 ...
 if(isset($_POST["btnedit"])){
   ...
   $sql = "update  tblteacher set fullname='".$_POST['txtfullname']."',sex='".$_POST['cmdsex']."',email='".$_POST['txtemail']."' where teacherID= '$teacherID'";
...
<span class="m-r-sm text-muted welcome-message">Welcome to <?php echo $rowaccess['fullname'];?></span>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
          ...
          <option value="Female">Female</option>
                                    ...
                                    <input type="email" name="txtemail" value="<?php echo $rowaccess['email']; ?>"  class="form-control" required="">
                                    </div>
