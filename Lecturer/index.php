...
<title>Lecturer Dashboard |<?php echo $website_name ;?> </title>
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"><span class="text-muted text-xs block">Lecturer ID:<?php echo $rowaccess['lecturerID'];  ?> <b class="caret"></b></span> </span> </a>
...
?>
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                              <h5><span class="label label-primary pull-right">Lecturer ID </span>
</h5>
                            </div>

                            <div class="ibox-content">
                                <h3 class="no-margins"><?php echo $lecturerID; ?> </h3>
                                <small> </small>
						  </div>
                        </div>
                    </div>
					...
					<div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                              <h5><span class="label label-secondary pull-right">Status</span>
</h5>
                            </div>
