...
$rowaccess = mysqli_fetch_array($result);
 ...
 if(isset($_POST["btnedit"])){
   ...
   $sql = "update  tblstudent set fullname='".$_POST['txtfullname']."',sex='".$_POST['cmdsex']."',phone='".$_POST['txtphone']."',address='".$_POST['txtaddress']."',state='".$_POST['cmdstate']."' where admissionID= '$admissionID'";
...
<span class="m-r-sm text-muted welcome-message">Welcome to <?php echo $rowaccess['fullname'];?></span>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
          ...
          <option value="Female">Female</option>
                                    ...
                                    <input type="text" name="txtphone" value="<?php echo $rowaccess['phone']; ?>"  class="form-control" >
                                    </div>
                                    <div class="form-group"><strong>
                                    <label>Address</label></strong>
                                    <input type="text" name="txtaddress" value="<?php echo $rowaccess['address']; ?>"  class="form-control" >
                                    </div>
                                    <div class="form-group"><strong>
                                    <label>State</label></strong>
                                    <select name="cmdstate" class="form-control" id="state" >
                                    <option value="<?php echo $rowaccess['state']; ?>"><?php echo $rowaccess['state']; ?></option>
          ...
          <option value="Zamfara">Zamfara</option>
	                        	...
	                        	<p>   </p>
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit" name="btnedit"><strong>Edit</strong></button>
                                    </div>
                                </form>
                            </div>
                            <div class="col-sm-6">
