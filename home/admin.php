...
<title>Admin login |<?php echo $website_name ;?></title>
           ...
           <div class="form-holder">
                <div class="form-content">
                    <div class="form-items"><h4 ><?php //echo $message; ?></h4>
                      <p align="center" ><a href="index.php"><span class="logos"><img class="logo-size" src="<?php echo $logo; ?>" alt="" height="90" width="100"></span></a></p>
                      <h3><?php echo $website_name ;?> - Admin Login Form</h3>
                        <p>&nbsp;</p>
                        <p> </p>
                        <div class="page-links">
                            <a href="index.php" >Student Login</a><a href="register.php">Student Registration</a><a href="admin.php"class="active">Admin</a>
                        </div>
