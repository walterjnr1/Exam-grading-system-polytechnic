...
<head>
  ...
  <title>Result Summary|Dashboard</title>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="card-body">
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    <thead>
                        ...
                        <th><div align="center" class="style1">SN</div></th>
                              <th><div align="center" class="style1">Term </div></th>
                              <th><div align="center" class="style1">Session</div></th>
                              <th><div align="center" class="style1">Class</div></th>
                              <th><div align="center" class="style1">Teacher </div></th>
                              <th><div align="center" class="style1">Action </div></th>
                    ...
                    <tbody>
                    <?php
					$sql = "SELECT tblresultsummary.*,tblresultsummary.ID as id, tblteacher.* FROM tblteacher JOIN tblresultsummary ON tblteacher.teacherID=tblresultsummary.teacherID order by tblresultsummary.teacherID  ";
    			//$sql = "SELECT * FROM tblresult order by term and school_session";
				$result = $conn->query($sql);
				$cnt=1;
		  ...
		  ?>
                      <tr class="gradeX">
                              <td class="center"><div align="center"><?php echo $cnt; ?></div></td>
                              <td><div align="center"><?php echo $row['term'];  ?> </div></td>
                              <td class="center"><div align="center"><?php echo $row['school_session'];  ?></div></td>
                              <td><div align="center"><?php echo $row['class_arm'];  ?> </div></td>
                              <td class="center"><div align="center"><?php echo $row['fullname'];  ?></div></td>
                              <td><div align="center"><a href="delete-result.php?id=<?php echo $row['id'];?>&classid=<?php echo $row['class_arm'];?>&sessionid=<?php echo $row['school_session'];?>&termid=<?php echo $row['term'];?>" onClick="return deldata();">Delete</a>
</div></td>
