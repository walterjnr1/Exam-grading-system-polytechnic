...
{ 
 // it return number of rows in the table. 
 $row_subjects = mysqli_num_rows($result); 
...
?>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-primary elevation-1"><i class="fa  fa-period" id="icon"></i></span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-secondary elevation-1"><i class="fa fa-book" id="icon"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">No. Of Course(s) </span>
                <span class="info-box-number">
                  <?php  echo $row_subjects;   ?>
                  <small></small>
                </span>
              </div>
              <!-- /.info-box-content -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">No. Of Uploaded result(s) </span>
                <span class="info-box-number">
                  <?php  echo $row_results;   ?>
                  <small></small>
                </span>
              </div>
              <!-- /.info-box-content -->
...
?>
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                      <li>
                        <img src="../home/<?php echo $row_new_students['photo'];  ?>" alt="students Image">
