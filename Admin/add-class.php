...
$class = mysqli_real_escape_string($conn,$_POST['txtclass']);


//save class details
$query = "INSERT into `tblclass` (class)
VALUES ('$class')";
            ...
            <div class="card card-primary">
              ...
              <form id="form" action="" method="post" class="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtclass" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtclass']))?><?php echo $_POST['txtclass']; ?>" placeholder="Enter Class">
                  </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                                         <?php 
                                          $sql = "SELECT * FROM tblclass order by class";
                                           $result = $conn->query($sql); 
										$cnt=1;
                    ...
                    <div class="dropdown-menu" role="menu">
                      ...
                      <a class="dropdown-item" href="delete-class.php?id=<?php echo $row['ID'];?>" onClick="return deldata();">Delete</a>
