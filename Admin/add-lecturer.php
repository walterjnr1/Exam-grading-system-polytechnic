...
//save users details
$query = "INSERT into `tbllecturer` (lecturerID,fullname,password,sex,email,date_reg,status,photo)
VALUES ('$lecturerID','$fullname','$password','$sex','$email','$current_date','1','uploadImage/default.jpg')";
  ...
  $_SESSION['error'] ='Problem Adding lecturer';
...
<head>
  ...
  <title>Add lecturer|Dashboard</title>
...
return  true;
  ...
  <script type="text/javascript">
		function deldata(){
if(confirm("ARE YOU SURE YOU WISH TO DELETE THIS lecturer ?" ))
{
return  true;
}
else {return false;
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-primary">
              ...
              <form id="form" action="" method="post" class="">
                ...
                <div class="card-footer">
                  <button type="submit" name="btncreate" class="btn btn-primary">Add</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Lecturer Record</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tr> <th width="3%"><div align="center">#</div></th>
                        ...
                        <th width="13%"><div align="center">lecturer ID</div></th>
							          <th width="8%"><div align="center">Sex</div></th>
                        <th width="7%"><div align="center">Email</div></th>
                    ...
                    <tbody>
                                         <?php 
                                          $sql = "SELECT * FROM tbllecturer order by date_reg ASC";
                                           $result = $conn->query($sql); 
										$cnt=1;
					  ...
					  <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        ...
                        <td><div align="center"><?php echo $row['lecturerID']; ?></div></td>
                    <td><div align="center"><?php echo $row['sex']; ?></div></td>
                    <td><div align="center"><?php echo $row['email']; ?></div></td>
                    <td><div align="center"><img src="../home/<?php echo $row['photo'];?>"  width="91" height="73" border="2"/></div></td>
                    ...
                    <div class="dropdown-menu" role="menu">
                      ...
                      <a class="dropdown-item" href="delete-lecturer.php?id=<?php echo $row['ID'];?>" onClick="return deldata();">Delete</a>
                      <?php if (($row['status'])==(('1')))  { ?>
                      <a class="dropdown-item" href="block-unblock-lecturer.php?id=<?php echo $row['ID'];?>" onClick="return Deactivate('<?php echo $row['fullname']; ?> ');">Deactivate</a>
					  <?php } else {?>
					  <a class="dropdown-item" href="block-unblock-lecturer.php?uid=<?php echo $row['ID'];?>" onClick="return Activate('<?php echo $row['fullname']; ?> ');">Activate</a>
					  <?php } ?>
                    </div>
                  </div>
                </td>
